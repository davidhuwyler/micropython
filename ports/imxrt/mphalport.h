...
//TODO add proper functionality (used by onewire module)
static inline uint32_t mp_hal_quiet_timing_enter(void){return 1;}
static inline void mp_hal_quiet_timing_exit(uint32_t i){}
